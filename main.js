...
function car2_down()
{
	...
	{
		car1_y =car1_y+ 10;
		console.log("When key s is pressed,  x = " + car2_y + " | y = " +car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left()
{
	...
	{
		car2_x =car2_y - 10;
		console.log("When key a is pressed,  x = " + car2_x + " | y = " +car2_x);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right()
{
	...
	{
		car2_x =car2_y + 10;
		console.log("When key d is pressed,  x = " + car2_x + " | y = " +car2_x);
		uploadBackground();
		uploadcar1();
		 uploadcar2();
   }
...
if (car1_x > 700) {
	...
	document.getElementById('game_status').innerHTML = "Congratulations Car 1 Won the Game!!"
}

if (car2_x > 700) {
	console.log("car2 Won");
	document.getElementById('game_status').innerHTML = "Congratulations Car 2 Won the Game!!"
}